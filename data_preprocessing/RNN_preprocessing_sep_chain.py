...
# Generate sequences
X1_seq, y1_seq = create_sequences(fes.X1, fes.y1_cat, seq_length)

# Further split using train_test_split
X1_seq_train, X1_seq_test, y1_seq_train, y1_seq_test = train_test_split(X1_seq, y1_seq, test_size=0.2, random_state=0)

# Generate sequences
X2_seq, y2_seq = create_sequences(fes.X2, fes.y2_cat, seq_length)

# Further split using train_test_split
X2_seq_train, X2_seq_test, y2_seq_train, y2_seq_test = train_test_split(X2_seq, y2_seq, test_size=0.2, random_state=0)
